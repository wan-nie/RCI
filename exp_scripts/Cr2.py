...
def parse_args():
    ...
    parser.add_argument('--base_port', type=int, default=47500,
                        help='Base port for distributed training (default: 47500)')
    parser.add_argument('--impt_expand', type=float, default=1.0)
    parser.add_argument('--n_iters', type=int, default=100)
    parser.add_argument('--diag_of', type=str, default='clic', choices=['solax', 'clic', 'davidson'])
...
def main():
    ...
    for idx, (mol, N_orb) in enumerate(zip(mol_names, orbs)):
        ...
        cmd = [
            ...
            '--integral_path', 'data/Cr2/Cr2_48e42o.FCIDUMP',
